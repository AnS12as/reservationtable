...
class Booking(models.Model):
    ...
    name = models.CharField(
        max_length=100, verbose_name="Имя клиента", default="Неизвестный"
    )
    phone = models.CharField(
        max_length=20, verbose_name="Телефон", default="Нет телефона"
    )
...
class RestaurantInfo(models.Model):
    ...
    address = models.CharField(
        max_length=255, default="Не указан", verbose_name="Адрес"
    )
    phone = models.CharField(
        max_length=20, verbose_name="Телефон", default="+7 898 176 54 67"
    )
